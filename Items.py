class Equipment:
	...
	Clothes = {"name": "CLOTHES", "type": "ARMOUR", "price": 1, "equipLocation": "CHEST", "equipClass": "ALL", "DEF": 1}
	# Warrior Equipment
	LeatherArmour = {"name": "LEATHER-ARMOUR", "type": "ARMOUR", "price": 10, "equipLocation": "CHEST", "equipClass": "WARRIOR",
						  "DEF": 2}
	# Mage Equipment
	Robe = {"name": "ROBE", "type": "ARMOUR", "price": 10, "equipLocation": "CHEST", "equipClass": "MAGE", "DEF": 2}
	# Thief Equipment
	Bandana = {"name": "BANDANA", "type": "ARMOUR", "price": 5, "equipLocation": "HEAD", "equipClass": "THIEF", "DEF": 1}
	# Offense Equipment
	# All Class Equipment
	Knife = {"name": "KNIFE", "type": "WEAPON", "price": 10, "equipLocation": "HAND", "equipClass": "ALL", "STR": 2}
	# Warrior Equipment
	WoodenSword = {"name": "WOODEN-SWORD", "type": "WEAPON", "price": 1, "equipLocation": "HAND", "equipClass": ("WARRIOR", "THIEF"),
				   "STR": 1}
	# Mage Equipment
	WoodenWand = {"name": "WOODEN WAND", "type": "WEAPON", "price": 1, "equipLocation": "HAND", "equipClass": "MAGE", "STR": 1}
	# Thief Equipment
	Dagger = {"name": "DAGGER", "type": "WEAPON", "price": 40, "equipLocation": "HAND", "equipClass": "ALL", "STR": 5}
