class mobList:
	...
	rat = {"name": "RAT", "type": "NORMAL", "weakness": "NONE", "HP": 8, "STR": 6, "DEF": 0, "SPEED": 5, "XP": 8, "GOLD": 4, "ICON": "r"}
	spider = {"name": "SPIDER", "type": "NORMAL", "weakness": "FIRE", "inflict": ("POISONED", 30), "HP": 15, "STR": 6, "DEF": 0, "SPEED": 8, "XP": 12, "GOLD": 6, "ICON": "s"}
	queenSpider = {"name": "QUEEN SPIDER", "type": "BOSS", "weakness": "FIRE", "inflict": ("POISONED", 30), "HP": 50, "STR": 8, "DEF": 2, "SPEED": 3, "XP": 50, "GOLD": 50, "ICON": "q"}
